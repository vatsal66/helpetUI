...
const Question5Accordian1 = ({ handleChange, expanded }) => {
  return (
    <Accordion sx={{
      ...
      zIndex: 2,
    }} expanded={expanded === 'Question5Accordian1'} onChange={handleChange('Question5Accordian1')}>
      <AccordionSummary
        expandIcon={<ArrowDown />}
        aria-controls="Question5Accordian1-content"
        id="Question5Accordian1-header"
        sx={{
          padding: '10px 40px',
...
export default Question5Accordian1;