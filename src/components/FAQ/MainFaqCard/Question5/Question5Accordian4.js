...
const Question5Accordian4 = ({ handleChange, expanded }) => {
  return (
    <Accordion sx={{
      ...
      zIndex: 2,
    }} expanded={expanded === 'Question5Accordian4'} onChange={handleChange('Question5Accordian4')}>
      <AccordionSummary
        expandIcon={<ArrowDown />}
        aria-controls="Question5Accordian4-content"
        id="Question5Accordian4-header"
        sx={{
          padding: '10px 40px',
...
export default Question5Accordian4;