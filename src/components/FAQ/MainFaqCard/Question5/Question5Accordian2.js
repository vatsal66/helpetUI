...
const Question5Accordian2 = ({ handleChange, expanded }) => {
  return (
    <Accordion sx={{
      ...
      zIndex: 2,
    }} expanded={expanded === 'Question5Accordian2'} onChange={handleChange('Question5Accordian2')}>
      <AccordionSummary
        expandIcon={<ArrowDown />}
        aria-controls="Question5Accordian2-content"
        id="Question5Accordian2-header"
        sx={{
          padding: '10px 40px',
...
export default Question5Accordian2;