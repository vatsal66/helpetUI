...
const Question6Accordian4 = ({ handleChange, expanded }) => {
  return (
    <Accordion sx={{
      ...
      zIndex: 2,
    }} expanded={expanded === 'Question6Accordian4'} onChange={handleChange('Question6Accordian4')}>
      <AccordionSummary
        expandIcon={<ArrowDown />}
        aria-controls="Question6Accordian4-content"
        id="Question6Accordian4-header"
        sx={{
          padding: '10px 40px',
...
export default Question6Accordian4;