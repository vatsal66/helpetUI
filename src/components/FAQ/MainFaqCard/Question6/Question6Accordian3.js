...
const Question6Accordian3 = ({ handleChange, expanded }) => {
  return (
    <Accordion sx={{
      ...
      zIndex: 2,
    }} expanded={expanded === 'Question6Accordian3'} onChange={handleChange('Question6Accordian3')}>
      <AccordionSummary
        expandIcon={<ArrowDown />}
        aria-controls="Question6Accordian3-content"
        id="Question6Accordian3-header"
        sx={{
          padding: '10px 40px',
...
export default Question6Accordian3;