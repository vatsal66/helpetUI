...
const Question1Accordian1 = ({ handleChange, expanded }) => {
  return (
    <Accordion sx={{
      ...
      zIndex: 2,
    }} expanded={expanded === 'Question1Accordian1'} onChange={handleChange('Question1Accordian1')}>
      <AccordionSummary
        expandIcon={<ArrowDown />}
        aria-controls="Question1Accordian1-content"
        id="Question1Accordian1-header"
        sx={{
          padding: '10px 40px',
...
export default Question1Accordian1;