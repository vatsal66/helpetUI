...
const Question1Accordian3 = ({ handleChange, expanded }) => {
  return (
    <Accordion sx={{
      ...
      zIndex: 2,
    }} expanded={expanded === 'Question1Accordian3'} onChange={handleChange('Question1Accordian3')}>
      <AccordionSummary
        expandIcon={<ArrowDown />}
        aria-controls="Question1Accordian3-content"
        id="Question1Accordian3-header"
        sx={{
          padding: '10px 40px',
...
export default Question1Accordian3;