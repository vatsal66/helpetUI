...
const Question3Accordian1 = ({ handleChange, expanded }) => {
  return (
    <Accordion sx={{
      ...
      zIndex: 2,
    }} expanded={expanded === 'Question3Accordian1'} onChange={handleChange('Question3Accordian1')}>
      <AccordionSummary
        expandIcon={<ArrowDown />}
        aria-controls="Question3Accordian1-content"
        id="Question3Accordian1-header"
        sx={{
          padding: '10px 40px',
...
export default Question3Accordian1;