...
const Question3Accordian4 = ({ handleChange, expanded }) => {
  return (
    <Accordion sx={{
      ...
      zIndex: 2,
    }} expanded={expanded === 'Question3Accordian4'} onChange={handleChange('Question3Accordian4')}>
      <AccordionSummary
        expandIcon={<ArrowDown />}
        aria-controls="Question3Accordian4-content"
        id="Question3Accordian4-header"
        sx={{
          padding: '10px 40px',
...
export default Question3Accordian4;