...
const Question3Accordian2 = ({ handleChange, expanded }) => {
  return (
    <Accordion sx={{
      ...
      zIndex: 2,
    }} expanded={expanded === 'Question3Accordian2'} onChange={handleChange('Question3Accordian2')}>
      <AccordionSummary
        expandIcon={<ArrowDown />}
        aria-controls="Question3Accordian2-content"
        id="Question3Accordian2-header"
        sx={{
          padding: '10px 40px',
...
export default Question3Accordian2;