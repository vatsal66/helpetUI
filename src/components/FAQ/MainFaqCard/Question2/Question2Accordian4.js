...
const Question2Accordian4 = ({ handleChange, expanded }) => {
  return (
    <Accordion sx={{
      ...
      zIndex: 2,
    }} expanded={expanded === 'Question2Accordian4'} onChange={handleChange('Question2Accordian4')}>
      <AccordionSummary
        expandIcon={<ArrowDown />}
        aria-controls="Question2Accordian4-content"
        id="Question2Accordian4-header"
        sx={{
          padding: '10px 40px',
...
export default Question2Accordian4;