...
const Question2Accordian3 = ({ handleChange, expanded }) => {
  return (
    <Accordion sx={{
      ...
      zIndex: 2,
    }} expanded={expanded === 'Question2Accordian3'} onChange={handleChange('Question2Accordian3')}>
      <AccordionSummary
        expandIcon={<ArrowDown />}
        aria-controls="Question2Accordian3-content"
        id="Question2Accordian3-header"
        sx={{
          padding: '10px 40px',
...
export default Question2Accordian3;