...
const Question2Accordian2 = ({ handleChange, expanded }) => {
  return (
    <Accordion sx={{
      ...
      zIndex: 2,
    }} expanded={expanded === 'Question2Accordian2'} onChange={handleChange('Question2Accordian2')}>
      <AccordionSummary
        expandIcon={<ArrowDown />}
        aria-controls="Question2Accordian2-content"
        id="Question2Accordian2-header"
        sx={{
          padding: '10px 40px',
...
export default Question2Accordian2;